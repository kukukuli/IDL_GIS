...
namespace 遥感数据管理系统
{
    public partial class IDL_AR : Form
    {
        private COM_IDL_connectLib.COM_IDL_connect IDLcom;
        private AxMapControl m_pMapCtrl = null;
        public IDL_AR(COM_IDL_connectLib.COM_IDL_connect IDLco, AxMapControl pMapControl)
        {
            InitializeComponent();
            this.IDLcom = IDLco;
        ...
        private void btnok_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string i11 = @".compile -v '" + proCommand + "\\Exct.pro" + "'";
                this.IDLcom.ExecuteString(i11);

                string cm = @"Exct,'" + InputFile + "','" + Inputxml + "','" + InputSaveFile + "'";
